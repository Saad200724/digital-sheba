...
const HeroBanner = () => {
  ...
  const slides = [
    {
      ...
      image:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Logo_Microsoft_Office_365_%282013-2019%29.svg/960px-Logo_Microsoft_Office_365_%282013-2019%29.svg.png?20190416222239",
    },
    {
  ...
  const checkDomainAvailability = async () => {
    ...
    const domainName = domain.includes(".")
      ? domain.toLowerCase().trim()
      : `${domain.toLowerCase().trim()}${selectedExtension}`;
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex-1 max-w-lg">
                  ...
                  <p className="text-white/80 mb-6 text-sm md:text-base">{slides[currentSlide].subtitle}</p>
                ...
                {availability === "available" ? (
                  <>
                    ...
                    <Button
                      ...
                      size="sm"
                      className="ml-auto bg-green-500 hover:bg-green-600 h-6 px-2 text-xs"
                    >
                      Claim
                    </Button>
                  </>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-gradient-to-br from-cyan-500 to-teal-600 rounded-xl p-4 text-white">
              ...
              <Button
                size="sm"
                variant="outline"
                className="bg-white/10 border-white/30 text-white hover:bg-white/20 text-xs h-7 px-3"
              >
                View Details
              </Button>
            </div>
